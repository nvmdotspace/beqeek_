...
/**
 * Documents Page - Example implementation of beqeek-editor
 *
 * This is a future feature placeholder demonstrating the integration
 * of @workspace/beqeek-editor package for Notion-like document editing.
 *
 * Features:
 * - Rich text editing with Yoopta Editor v4
 * - 18 plugins: Typography, Lists, Structural, Code, Media
 * - 3 editing tools: ActionMenu (slash commands), Toolbar, LinkTool
    ...
    <div className="flex h-full flex-col bg-background">
      ...
      <div className="border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="flex h-14 items-center px-6">
          <h1 className="text-lg font-semibold">{m.navigation_documents()}</h1>
          <div className="ml-auto flex items-center gap-2">
            <span className="text-sm text-muted-foreground">Future feature - Example implementation</span>
          </div>
        </div>
      </div>

      {/* Editor Container - Full width layout */}
      <div className="flex-1 overflow-auto">
        <div className="mx-auto max-w-5xl px-6 py-8">
          {/* Info Card */}
          <div className="mb-6 rounded-lg border border-border bg-muted/50 p-4">
            <h2 className="mb-2 font-semibold">📝 Beqeek Editor Example</h2>
            <p className="mb-3 text-sm text-muted-foreground">
              This page demonstrates the <code className="rounded bg-muted px-1 py-0.5">@workspace/beqeek-editor</code>{' '}
              package with full editing capabilities.
            </p>
            <div className="space-y-1 text-sm text-muted-foreground">
              ...
              <ul className="ml-4 list-disc space-y-0.5">
                <li>
                  <kbd className="rounded border border-border bg-background px-1.5 py-0.5 text-xs">/</kbd> - Open slash
                  commands (ActionMenu)
                </li>
                <li>
                  <kbd className="rounded border border-border bg-background px-1.5 py-0.5 text-xs">Cmd+B</kbd> - Bold |{' '}
                  <kbd className="rounded border border-border bg-background px-1.5 py-0.5 text-xs">Cmd+I</kbd> - Italic
                  | <kbd className="rounded border border-border bg-background px-1.5 py-0.5 text-xs">Cmd+U</kbd> -
                  Underline
                </li>
                <li>
                  <kbd className="rounded border border-border bg-background px-1.5 py-0.5 text-xs">Cmd+K</kbd> - Insert
                  link (LinkTool)
                </li>
          ...
          <BeqeekEditor
            ...
            tools={tools}
            marks={marks}
            value={DEMO_INIT_VALUE}
            autoFocus
            placeholder="Start typing... Try pressing '/' for commands or select text to format"
            className="min-h-[700px] rounded-lg border border-border bg-background p-8 shadow-sm"
          />

          {/* Footer Info */}
          <div className="mt-6 rounded-lg border border-border bg-muted/30 p-4">
            <h3 className="mb-2 text-sm font-semibold">Package Information</h3>
            <div className="space-y-1 text-xs text-muted-foreground">
              <p>
                <strong>Package:</strong> @workspace/beqeek-editor v0.1.0
              </p>
              <p>
                <strong>Based on:</strong> Yoopta Editor v4.0.0
              </p>
              <p>
                <strong>Features:</strong> 14 plugins, 3 tools, 6 marks
              </p>
              <p>
                <strong>Integration:</strong> shadcn/ui components + TailwindCSS v4
              </p>
            </div>
          </div>
        </div>
...
// Demo initial value - "The Joke Tax Chronicles" from Yoopta Editor examples
const DEMO_INIT_VALUE: EditorValue = {
    ...
    value: [
      {
        ...
        type: 'heading-one',
        children: [{ text: 'The Joke Tax Chronicles' }],
    ...
    value: [
      {
        ...
        children: [
          ...
          { text: ' ' },
          {
            ...
            children: [{ text: 'a brilliant plan' }],
          },
    ...
    value: [
      {
        ...
        type: 'bulleted-list',
        children: [{ text: '1st level of puns: 5 gold coins' }],
        props: { nodeType: 'block' },
      },
    ],
    type: 'BulletedList',
    meta: { order: 7, depth: 0, align: 'left' },
  },
    ...
    value: [
      {
        ...
        type: 'bulleted-list',
        children: [{ text: '2nd level of jokes: 10 gold coins' }],
        props: { nodeType: 'block' },
      },
    ],
    type: 'BulletedList',
    meta: { order: 8, depth: 0, align: 'left' },
  },
    ...
    value: [
      {
        ...
        type: 'bulleted-list',
        children: [{ text: '3rd level of one-liners : 20 gold coins' }],
        props: { nodeType: 'block' },
      },
    ],
    type: 'BulletedList',
    meta: { order: 9, depth: 0, align: 'left' },
  },
    ...
    value: [
      {
        ...
        type: 'heading-three',
        children: [{ text: "Jokester's Revolt" }],
        props: { nodeType: 'block' },
      },
    ],
    type: 'HeadingThree',
    ...
    value: [
      {
        ...
        type: 'heading-three',
        children: [{ text: "The People's Rebellion" }],
        props: { nodeType: 'block' },
      },
    ],
    type: 'HeadingThree',
            ...
            children: [
              {
                ...
                children: [{ text: 'What the best football club?' }],
                props: { nodeType: 'block' },
              },
              {
                id: 'b8f0fe33-9673-4fa5-bc73-4b20735ea7ed',
                type: 'accordion-list-item-content',
                children: [{ text: 'Chelsea FC is the best football club in the world' }],
                props: { nodeType: 'block' },
              },
            ],
            ...
            children: [
              {
                ...
                type: 'accordion-list-item-heading',
                children: [{ text: 'Is it styled?' }],
                props: { nodeType: 'block' },
              },
              {
                id: '6358786d-f99d-4d5c-8ff7-51e247b4eed3',
                type: 'accordion-list-item-content',
                children: [{ text: "Yes. It comes with default styles that matches the other components' aesthetic." }],
                props: { nodeType: 'block' },
              },
            ],
            props: { nodeType: 'block', isExpanded: true },
            ...
            children: [
              {
                ...
                type: 'accordion-list-item-heading',
                children: [{ text: 'Is it animated?' }],
                props: { nodeType: 'block' },
              },
              {
                id: '4bfe30c3-3f4a-46d5-93dd-065bb901b4e0',
                type: 'accordion-list-item-content',
                children: [{ text: 'Yes. It`s animated by default, but you can disable it if you prefer' }],
                props: { nodeType: 'block' },
              },
            ],
            props: { nodeType: 'block', isExpanded: true },
