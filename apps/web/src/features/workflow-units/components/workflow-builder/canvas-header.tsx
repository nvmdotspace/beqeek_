...
import { Save, AlertCircle, FileQuestion, Undo2, Redo2, Network } from 'lucide-react';
...
export function CanvasHeader({ workspaceId }: CanvasHeaderProps) {
  ...
  useEffect(() => {
    const handleKeyDown = (e: KeyboardEvent) => {
      ...
      // Auto-layout: Cmd+Shift+L / Ctrl+Shift+L
  ...
  }, [canUndo, canRedo, undo, redo, handleAutoLayout]);
