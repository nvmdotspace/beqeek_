...
- [ ] **Design System Compliance**: Review `docs/design-system.md` for UI/UX requirements
- [ ] **Component Library**: Use existing components from `@workspace/ui` before creating new ones
- [ ] **Styling Guidelines**: Follow CSS custom properties and spacing system defined in design system
...
- **Mandatory Compliance**: All UI changes MUST follow `docs/design-system.md`
...
1. **Primary Reference**: `docs/design-system.md`
2. **Component Library**: `packages/ui/src/components/`
3. **Style Guidelines**: CSS custom properties in design system
4. **Typography**: Vietnamese-optimized font stacks and spacing
...
1. Check `docs/design-system.md` for compliance
2. Verify component usage follows established patterns
3. Ensure responsive design with proper breakpoints
4. Validate accessibility requirements (WCAG 2.1 AA)
5. Check TypeScript strict typing for all components
...
Remember: Specs are truth. Changes are proposals. Design system is law. Keep them in sync.
